    ...
    <div className="pb-4 h-[calc(100vh-5rem)]">
      <div className="w-full h-full relative">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 w-full max-w-md p-4 flex flex-col gap-4 items-center md:max-w-3xl xl:gap-8 xl:max-w-4xl">
          <h1 className="font-semibold text-center text-3xl md:text-4xl lg:text-5xl xl:text-6xl uppercase bg-clip-text text-transparent bg-gradient-to-r from-blue-200 to-white dark:from-yellow-200 dark:to-white pt-2 lg:pt-4">
